...
function App() {
  ...
  return (
    <>
      <div
        className="main h-[100vh] w-[100vw] flex  justify-center items-center bg-zinc-800
      "
      >
        <div
...
"
        >
          <div className="searchBar flex items-center ">
            ...
            <button
              onClick={getData}
              className="h-[8vh] w-[8vw] flex justify-center items-center  text-white rounded-r-2xl shadow-sm shadow-black 
